...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="mid">
        <div class="graybox4">
          <div class="graybox_topbg4"><img src="images/arrow.png" width="8" height="10" />ShepMartz Login</div>
          <div class="graybox_conbg4">
            <div class="con4" >
              <div id='login'>
                <div class='inner'>
                  ...
                  <div class='fheader'>
                    ...
                    <div style="color: red; display: none; font-size: 10px;" id="mailErr">Please Enter Email Id</div>
                  </div>
                  <form action="save" method='POST' id='loginForm' class='cssform' autocomplete='on'>
                    <p>
                      <label for='username'>Username</label>
                      <input type='text' class='text_' name='userName' value="${params.userName}" id='username' />
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      <input type='text' class='text_' value="${params.email}" name='email' id='email' />
                    </p>
                    <p>
                      <input type='submit' value='Register' name="submit" id="submit"/> 
                      <g:link controller="login" class="details" action="index">Login</g:link>
                   </p>
                  </form>
                 </div>
              </div>
