            ...
            <div id="content">
              ...
              <div id="dialog" class="myform">
                ...
                <div>
                  ...
                  <span style="margin:0px; padding:0px; position:relative; bottom:5px"><a name="fb_share" type="button" share_url="${request.getContextPath()}/images/shepmartz/${item.getName()}/${item.getName()}.${item.getUrl().substring(item.getUrl().lastIndexOf(".")+1,item.getUrl().size())}g" href="http://www.facebook.com/sharer.php"></a></span>
                  </g:if>
                  ...
                  <span style="margin:0px; padding:0px; position:relative; bottom:5px"><a name="fb_share" type="button" share_url="${request.getContextPath()}/images/shepmartz/${item.getName()}/${item.getName()}.${item.getUrl().substring(item.getUrl().lastIndexOf(".")+1,item.getUrl().size())}" href="http://www.facebook.com/sharer.php"></a></span>
                  </g:elseif>
                  ...
                  <span style="margin:0px; padding:0px; position:relative; bottom:5px"><a name="fb_share" type="button" share_url="${request.getContextPath()}/images/shepmartz/${item.getName()}/${item.getName()}.jpg" href="http://www.facebook.com/sharer.php"></a></span>
                  </g:elseif>
                  <g:else>
                    <img src ="${request.getContextPath()}/images/shepmartz/${item.getName()}/${item.getName()}.jpg" width="75" height="75" align="left" class="img" />
                  <span style="margin:0px; padding:0px; position:relative; bottom:5px"><a name="fb_share" type="button" share_url="${request.getContextPath()}/images/shepmartz/${item.getName()}/${item.getName()}.jpg" href="http://www.facebook.com/sharer.php"></a></span>
